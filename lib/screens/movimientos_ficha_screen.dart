...
class _MovimientosFichaScreenState extends State<MovimientosFichaScreen> {
                  ...
                  return Form(
                    child: Column(
                      children: [
                        ...
                        BtnGuardarMovWidget(dropdownCategoria: dropdownCategoria, dropdownCuenta: dropdownCuenta, dateinput: dateinput, spDescripcion: spDescripcion, spValor: spValor)
                      ],
                    ),
                  );
                },
  ...
  BlocConsumer<CategoriasBloc, CategoriasState> dropCategoriaMovFichaWidget() {
  ...
  BlocConsumer<CuentasBloc, CuentasState> dropCuentasMovFicha() {
